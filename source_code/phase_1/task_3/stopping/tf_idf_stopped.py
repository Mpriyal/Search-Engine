...
def get_index():
    global index_dict
    file = open('../../../../resources/index_stopped.txt','rU',encoding = 'utf-8')
...
def get_total_tokens():
    ...
    file = open('../../../../resources/docs_length_stopped.txt','rU',encoding = 'utf-8')
...
def get_queries():
    global query_dict
    file = open('../../../../resources/query_dict_stopped.txt','rU',encoding = 'utf-8')
...
def save_top_100():
    ...
    for query_id in query_dict.keys():
        ...
        out_file = open('../../../../output/system_run_output/tf_idf_stopped/'+'query_'+query_id+'.txt','w')
        rank = 0
        for tuple in sorted_tuples[:100]:
            rank += 1
            out_file.write(query_id+' Q0 '+tuple[0]+' '+str(rank)+' '+str(tuple[1])+' tf_idf_stopped\n')
    out_file.close()
